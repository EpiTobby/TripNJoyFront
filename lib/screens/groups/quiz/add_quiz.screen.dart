...
class AddQuiz extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final quizQuestionController = useTextEditingController();
    final multipleChoiceQuiz = useState<bool>(false);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (options.value.length > 1 && quizQuestionController.value.text.isNotEmpty)
            IconButton(
              icon: Icon(
                Icons.check,
              ...
              onPressed: () async {
                await ref.read(pollProvider).addPoll(
                      ...
                      PostSurveyRequest(
                        ...
                        content: quizQuestionController.value.text,
                        isMultipleChoiceSurvey: multipleChoiceQuiz.value,
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Checkbox(
                      value: multipleChoiceQuiz.value,
                      onChanged: (value) => multipleChoiceQuiz.value = value ?? false),
                  Text(
