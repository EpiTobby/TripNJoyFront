...
abstract class Api extends ChopperService {
  ...
  Future<chopper.Response<List<SurveyModel>>> surveysIdGet({required num? id}) {
    generatedMapping.putIfAbsent(SurveyModel, () => SurveyModel.fromJsonFactory);
  ...
  ///@param id
  @Get(path: '/surveys/{id}')
  Future<chopper.Response<List<SurveyModel>>> _surveysIdGet({@Path('id') required num? id});

  ///Create a survey in a challenge
  ///@param id
  Future<chopper.Response<SurveyModel>> surveysIdPost({required num? id, required PostSurveyRequest? body}) {
    generatedMapping.putIfAbsent(SurveyModel, () => SurveyModel.fromJsonFactory);
  ...
  ///@param id
  Future<chopper.Response<SurveyModel>> surveysIdPatch({required num? id, required UpdateSurveyRequest? body}) {
    generatedMapping.putIfAbsent(SurveyModel, () => SurveyModel.fromJsonFactory);
  ...
  Future<chopper.Response<SurveyModel>> _surveysIdPatch(
      {@Path('id') required num? id, @Body() required UpdateSurveyRequest? body});

  ///Vote for a survey
  ///@param id
  Future<chopper.Response<SurveyModel>> surveysVoteIdPost({required num? id, required VoteSurveyRequest? body}) {
    generatedMapping.putIfAbsent(SurveyModel, () => SurveyModel.fromJsonFactory);
  ...
  ///@param groupId
  Future<chopper.Response<GroupMemoriesResponse>> groupsGroupIdMemoriesGet({required num? groupId}) {
    generatedMapping.putIfAbsent(GroupMemoriesResponse, () => GroupMemoriesResponse.fromJsonFactory);
  ...
  Future<chopper.Response<GroupMemoriesResponse>> _groupsGroupIdMemoriesGet({@Path('groupId') required num? groupId});
  ...
  Future<chopper.Response<GroupMemoriesResponse>> _groupsGroupIdMemoriesPost(
      {@Path('groupId') required num? groupId, @Body() required GroupMemoryRequest? body});
  ...
  Future<chopper.Response<UserModel>> authRegisterAdminPost({required UserCreationRequest? body}) {
  ...
  Future<chopper.Response<UserModel>> _authRegisterAdminPost({@Body() required UserCreationRequest? body});
  ...
  ///Log a user, to allow authenticated endpoints
  Future<chopper.Response<LoginResponse>> authLoginAdminPost({required LoginRequest? body}) {
    generatedMapping.putIfAbsent(LoginResponse, () => LoginResponse.fromJsonFactory);
  ...
  Future<chopper.Response<LoginResponse>> _authLoginAdminPost({@Body() required LoginRequest? body});
  ...
  ///@param id
  Future<chopper.Response<FirebaseTokenResponse>> usersIdFirebaseGet({required num? id}) {
    generatedMapping.putIfAbsent(FirebaseTokenResponse, () => FirebaseTokenResponse.fromJsonFactory);
  ...
  Future<chopper.Response<FirebaseTokenResponse>> _usersIdFirebaseGet({@Path('id') required num? id});

  ///Update the firebase token associated to this user. If the token is not provided, it will be unset
  ///@param id
  ///@param token
  Future<chopper.Response> usersIdFirebasePatch({required num? id, String? token}) {
  ...
  Future<chopper.Response> _usersIdFirebasePatch({@Path('id') required num? id, @Query('token') String? token});
  ...
  ///Get all the surveys in a channel
  ///@param id
  Future<chopper.Response<List<SurveyModel>>> surveysQuizzIdGet({required num? id}) {
    generatedMapping.putIfAbsent(SurveyModel, () => SurveyModel.fromJsonFactory);
  ...
  Future<chopper.Response<List<SurveyModel>>> _surveysQuizzIdGet({@Path('id') required num? id});
  ...
  Future<chopper.Response<List<NotificationModel>>> notificationsGet() {
    generatedMapping.putIfAbsent(NotificationModel, () => NotificationModel.fromJsonFactory);
  ...
  ///@param group
  Future<chopper.Response<String>> groupsPrivateGroupQrcodeGet({required num? group}) {
  ...
  Future<chopper.Response<String>> _groupsPrivateGroupQrcodeGet({@Path('group') required num? group});
  ...
  Future<chopper.Response<GroupInfoModel>> groupsInfoIdGet({required num? id}) {
    generatedMapping.putIfAbsent(GroupInfoModel, () => GroupInfoModel.fromJsonFactory);
  ...
  Future<chopper.Response<GroupInfoModel>> _groupsInfoIdGet({@Path('id') required num? id});
  ...
  Future<chopper.Response> _reportsIdAdminDelete({@Path('id') required num? id});
  ...
  Future<chopper.Response> _notificationsIdDelete({@Path('id') required num? id});
...
class PossibleAnswerRequest {
  ...
  factory PossibleAnswerRequest.fromJson(Map<String, dynamic> json) => _$PossibleAnswerRequestFromJson(json);
    ...
    return identical(this, other) ||
        (other is PossibleAnswerRequest &&
            ...
            (identical(other.rightAnswer, rightAnswer) ||
                const DeepCollectionEquality().equals(other.rightAnswer, rightAnswer)));
  }
...
extension $PossibleAnswerRequestExtension on PossibleAnswerRequest {
  PossibleAnswerRequest copyWith({String? content, bool? rightAnswer}) {
    return PossibleAnswerRequest(content: content ?? this.content, rightAnswer: rightAnswer ?? this.rightAnswer);
  }
}
...
class PostSurveyRequest {
  ...
  factory PostSurveyRequest.fromJson(Map<String, dynamic> json) => _$PostSurveyRequestFromJson(json);
  ...
  @JsonKey(name: 'type', toJson: postSurveyRequestType$ToJson, fromJson: postSurveyRequestType$FromJson)
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is PostSurveyRequest &&
            (identical(other.userId, userId) || const DeepCollectionEquality().equals(other.userId, userId)) &&
            (identical(other.content, content) || const DeepCollectionEquality().equals(other.content, content)) &&
            (identical(other.quizz, quizz) || const DeepCollectionEquality().equals(other.quizz, quizz)) &&
            (identical(other.possibleAnswers, possibleAnswers) ||
                const DeepCollectionEquality().equals(other.possibleAnswers, possibleAnswers)) &&
            (identical(other.type, type) || const DeepCollectionEquality().equals(other.type, type)) &&
            (identical(other.canBeAnsweredMultipleTimes, canBeAnsweredMultipleTimes) ||
                const DeepCollectionEquality().equals(other.canBeAnsweredMultipleTimes, canBeAnsweredMultipleTimes)));
  }
...
extension $PostSurveyRequestExtension on PostSurveyRequest {
  PostSurveyRequest copyWith(
    ...
    return PostSurveyRequest(
        ...
        type: type ?? this.type,
        canBeAnsweredMultipleTimes: canBeAnsweredMultipleTimes ?? this.canBeAnsweredMultipleTimes);
  }
}
...
class PossibleAnswerModel {
  ...
  factory PossibleAnswerModel.fromJson(Map<String, dynamic> json) => _$PossibleAnswerModelFromJson(json);
...
extension $PossibleAnswerModelExtension on PossibleAnswerModel {
  PossibleAnswerModel copyWith({num? id, String? content, bool? rightAnswer}) {
    return PossibleAnswerModel(
        id: id ?? this.id, content: content ?? this.content, rightAnswer: rightAnswer ?? this.rightAnswer);
  }
}
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is SurveyModel &&
            ...
            (identical(other.quizz, quizz) || const DeepCollectionEquality().equals(other.quizz, quizz)) &&
            (identical(other.sendDate, sendDate) || const DeepCollectionEquality().equals(other.sendDate, sendDate)) &&
...
class VoteModel {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is VoteModel &&
            (identical(other.voter, voter) || const DeepCollectionEquality().equals(other.voter, voter)) &&
            (identical(other.answer, answer) || const DeepCollectionEquality().equals(other.answer, answer)));
  }

  @override
  int get hashCode =>
      const DeepCollectionEquality().hash(voter) ^ const DeepCollectionEquality().hash(answer) ^ runtimeType.hashCode;
}
...
class VoteSurveyRequest {
  ...
  factory VoteSurveyRequest.fromJson(Map<String, dynamic> json) => _$VoteSurveyRequestFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is VoteSurveyRequest &&
            (identical(other.voterId, voterId) || const DeepCollectionEquality().equals(other.voterId, voterId)) &&
            (identical(other.answerId, answerId) || const DeepCollectionEquality().equals(other.answerId, answerId)));
  }
...
extension $VoteSurveyRequestExtension on VoteSurveyRequest {
  VoteSurveyRequest copyWith({num? voterId, num? answerId}) {
    return VoteSurveyRequest(voterId: voterId ?? this.voterId, answerId: answerId ?? this.answerId);
  }
}
...
class GroupMemoryRequest {
  ...
  factory GroupMemoryRequest.fromJson(Map<String, dynamic> json) => _$GroupMemoryRequestFromJson(json);
    ...
    return identical(this, other) ||
        (other is GroupMemoryRequest &&
            (identical(other.memoryUrl, memoryUrl) ||
                const DeepCollectionEquality().equals(other.memoryUrl, memoryUrl)));
  }

  @override
  int get hashCode => const DeepCollectionEquality().hash(memoryUrl) ^ runtimeType.hashCode;
}
...
class GroupMemoriesResponse {
  ...
  factory GroupMemoriesResponse.fromJson(Map<String, dynamic> json) => _$GroupMemoriesResponseFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is GroupMemoriesResponse &&
            (identical(other.memories, memories) || const DeepCollectionEquality().equals(other.memories, memories)));
  }

  @override
  int get hashCode => const DeepCollectionEquality().hash(memories) ^ runtimeType.hashCode;
}
...
class UpdateSurveyRequest {
  ...
  factory UpdateSurveyRequest.fromJson(Map<String, dynamic> json) => _$UpdateSurveyRequestFromJson(json);
...
extension $UpdateSurveyRequestExtension on UpdateSurveyRequest {
  UpdateSurveyRequest copyWith(
      {String? question, List<PossibleAnswerRequest>? possibleAnswers, bool? canBeAnsweredMultipleTimes}) {
...
class JoinGroupWithoutInviteModel {
  ...
  @override
  int get hashCode => const DeepCollectionEquality().hash(message) ^ runtimeType.hashCode;
}
...
extension $ProfileEntityExtension on ProfileEntity {
  ProfileEntity copyWith({num? id, String? name, bool? active, DateTime? createdDate}) {
    ...
    return identical(this, other) ||
        (other is UserEntity &&
            ...
            (identical(other.firebaseToken, firebaseToken) ||
                const DeepCollectionEquality().equals(other.firebaseToken, firebaseToken)) &&
            (identical(other.language, language) || const DeepCollectionEquality().equals(other.language, language)) &&
            (identical(other.roles, roles) || const DeepCollectionEquality().equals(other.roles, roles)) &&
    ...
    return identical(this, other) ||
        (other is NotificationModel &&
            ...
            (identical(other.firebaseId, firebaseId) ||
                const DeepCollectionEquality().equals(other.firebaseId, firebaseId)));
  }
...
extension $NotificationModelExtension on NotificationModel {
  NotificationModel copyWith({String? title, String? body, num? userId, num? id, String? firebaseId}) {
...
class GroupInfoModel {
  ...
  @JsonKey(name: 'maxSize')
  final int? maxSize;
  @JsonKey(name: 'state', toJson: groupInfoModelStateToJson, fromJson: groupInfoModelStateFromJson)
...
class GroupMemberPublicInfoModel {
  ...
  factory GroupMemberPublicInfoModel.fromJson(Map<String, dynamic> json) => _$GroupMemberPublicInfoModelFromJson(json);
...
extension $GroupMemberPublicInfoModelExtension on GroupMemberPublicInfoModel {
  GroupMemberPublicInfoModel copyWith({num? id, String? firstname, String? lastname}) {
...
String? postSurveyRequestType$ToJson(enums.PostSurveyRequestType$? postSurveyRequestType$) {
  return enums.$PostSurveyRequestType$Map[postSurveyRequestType$];
}

enums.PostSurveyRequestType$ postSurveyRequestType$FromJson(Object? postSurveyRequestType$) {
  if (postSurveyRequestType$ is int) {
    return enums.$PostSurveyRequestType$Map.entries
        .firstWhere((element) => element.value.toLowerCase() == postSurveyRequestType$.toString(),
            orElse: () => const MapEntry(enums.PostSurveyRequestType$.swaggerGeneratedUnknown, ''))
        .key;
  }

  if (postSurveyRequestType$ is String) {
    return enums.$PostSurveyRequestType$Map.entries
        .firstWhere((element) => element.value.toLowerCase() == postSurveyRequestType$.toLowerCase(),
            orElse: () => const MapEntry(enums.PostSurveyRequestType$.swaggerGeneratedUnknown, ''))
        .key;
  }
...
List<String> postSurveyRequestType$ListToJson(List<enums.PostSurveyRequestType$>? postSurveyRequestType$) {
  if (postSurveyRequestType$ == null) {
    return [];
  }

  return postSurveyRequestType$.map((e) => enums.$PostSurveyRequestType$Map[e]!).toList();
}

List<enums.PostSurveyRequestType$> postSurveyRequestType$ListFromJson(List? postSurveyRequestType$) {
  if (postSurveyRequestType$ == null) {
    return [];
  }

  return postSurveyRequestType$.map((e) => postSurveyRequestType$FromJson(e.toString())).toList();
}
...
String? groupInfoModelStateToJson(enums.GroupInfoModelState? groupInfoModelState) {
  return enums.$GroupInfoModelStateMap[groupInfoModelState];
}

enums.GroupInfoModelState groupInfoModelStateFromJson(Object? groupInfoModelState) {
  if (groupInfoModelState is int) {
    return enums.$GroupInfoModelStateMap.entries
        .firstWhere((element) => element.value.toLowerCase() == groupInfoModelState.toString(),
            orElse: () => const MapEntry(enums.GroupInfoModelState.swaggerGeneratedUnknown, ''))
        .key;
  }

  if (groupInfoModelState is String) {
    return enums.$GroupInfoModelStateMap.entries
        .firstWhere((element) => element.value.toLowerCase() == groupInfoModelState.toLowerCase(),
            orElse: () => const MapEntry(enums.GroupInfoModelState.swaggerGeneratedUnknown, ''))
        .key;
  }
...
List<String> groupInfoModelStateListToJson(List<enums.GroupInfoModelState>? groupInfoModelState) {
  if (groupInfoModelState == null) {
    return [];
  }

  return groupInfoModelState.map((e) => enums.$GroupInfoModelStateMap[e]!).toList();
}

List<enums.GroupInfoModelState> groupInfoModelStateListFromJson(List? groupInfoModelState) {
  if (groupInfoModelState == null) {
    return [];
  }

  return groupInfoModelState.map((e) => groupInfoModelStateFromJson(e.toString())).toList();
}
