...
class BadRequestException extends HttpException {
  BadRequestException({required String message})
      : super(code: HttpStatus.badRequest, message: message);
}
...
class RequestTimeoutException extends HttpException {
  RequestTimeoutException({required String message})
      : super(code: HttpStatus.requestTimeout, message: message);
}

class ImATeapotException extends HttpException {
  ImATeapotException({required String message})
      : super(code: 418, message: message);
}

class InternalServerError extends HttpException {
  InternalServerError({required String message})
      : super(code: HttpStatus.internalServerError, message: message);
}

class BadGatewayException extends HttpException {
  BadGatewayException({required String message})
      : super(code: HttpStatus.badGateway, message: message);
}
...
class GatewayTimeoutException extends HttpException {
  GatewayTimeoutException({required String message})
      : super(code: HttpStatus.gatewayTimeout, message: message);
}
